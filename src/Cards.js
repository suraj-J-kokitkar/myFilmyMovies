...
import {moviesRef} from './component/firebase/firebase'
...
const Cards = () => {
  ...
  return (
    <div className="flex flex-wrap justify-between p-3 mt-2">
      {loading ?<div className='w-full flex justify-center item-center h-96'> <ThreeDots height={40} color="white"/></div>:
