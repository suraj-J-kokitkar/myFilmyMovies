...
import {confirmPasswordReset, getAuth, RecaptchaVerifier, signInWithPhoneNumber, SignInWithPhoneNumber } from 'firebase/auth'
    ...
    <div className='w-full flex flex-col mt-8 items-center'>
     ...
     <div class="p-2 w-full md:w-1/3">
        ...
        <div class="p-2 w-full">
          <button 
          onClick={requestOtp}
          class="flex mx-auto text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-700 rounded text-lg">{loading ? <TailSpin height={25} color='white'/>: 'Request OTP'}</button>
